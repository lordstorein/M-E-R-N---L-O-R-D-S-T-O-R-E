      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col mb-6">
          ...
          <div className="relative">
            ...
            <input id="password" type="password" name="password" value={user.password} onChange={handleInput} className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="Create Password" required />
          </div>
        </div>
