...
export const Alightmotion = ()=>{
    ...
    <section className='min-h-[100vh] flex flex-col bg-[#f0f0f0] pt-[40px]'>
      <>
        <Block amount={149} img={"/images/three.jpg"} heading={'Dark cc'} title={'This cc is not darker than your future'} productId={'am1'}/>

        <Block amount={99} img={'/images/one.jpg'} heading={'Gian cc'} title={'Gian hai aap, fr'} productId={'am2'}/>

        <Block amount={49} img={'/images/two.jpg'} heading={'Light cc'} title={'Gora pakora cc'} productId={'am3'}/>
      </>
      <Footer/>
